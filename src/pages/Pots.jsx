...
const Pots = () => {
  ...
  const wantedIds = [13, 2, 14, 15, 16, 17, 18, 4];
  const pots = products.filter((product) =>
        ...
        <div className="ml-10 mt-[60px]">
          <div className="mb-[46px] max-md:mt-[60px] w-full">
            <img
              ...
              src="/src/assets/background/bg_pots.avif"
              alt=""
            />
