...
const Sub = () => {
  ...
  const wantedIds = [19, 20];
  const sub = products.filter((product) =>
        ...
        <div className="ml-10 mt-[60px]">
          <div className="mb-[46px] max-md:mt-[60px] w-full">
            <img
              ...
              src="/src/assets/background/bg_sub.avif"
              alt=""
            />
            <h1 className="!mt-7 text-[90px] max-md:text-[40px] font-[forum]">
              {currentCategory}
            </h1>
          </div>
          <div className="mb-2">
          ...
          <div className="grid grid-cols-2 max-md:grid-cols-1 items-center gap-10">
            {sub.map((prd, idx) => (
              <div key={idx}>
                ...
                <div className="pr-5 pt-4 pb-5 w-full flex flex-col mb-2">
